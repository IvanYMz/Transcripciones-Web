...
export default function DropdownMenu() {
    const { toggleShowMenu, showMenu, setShowMenu, showSelectedTranscription, showTranscription } = useSession();
            ...
            {showMenu ? (
                <section className="dropdown-menu fixed top-0 left-0 bottom-0 flex w-full bg-transparent overflow-y-auto z-10">
                    ...
                    <div className="flex flex-col dark:bg-[#171717] h-full w-[290px] p-4 justify-between">
                        ...
                        <section className="overflow-y-auto h-full"><TranscriptionsList showSelectedTranscription={showSelectedTranscription} showTranscription={showTranscription} /></section>
